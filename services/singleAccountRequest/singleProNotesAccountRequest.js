    ...
    blocks: [
      {
        ...
        text: {
          type: 'plain_text',
          text: `${json.user.name} has requested for creating a ProNotes account`,
          emoji: true,
        },
      },
      {
        ...
        elements: [
          {
            ...
            action_id: 'createSingleProNotesAccountResult',
          },
        ],
      },
      {
